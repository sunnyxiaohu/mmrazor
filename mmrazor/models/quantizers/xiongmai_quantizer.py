...
class XiongmaiQuantizer(TorchNativeQuantizer):
    """Xiongmai class for quantizer.
    ...
    def export_onnx(self,
        ...
        onnx_model = onnx.load(symbolic_output_path)  # load onnx model
            ...
            for name, child in module.named_children():
                ...
                if isinstance(child, SUPPORT_QAT_MODULES):
                    ...
                    if keep_w_fake_quant:
                        ...
                        new_child.weight_fake_quant.zero_point = weight_fakequant.zero_point.int()
                    else:
