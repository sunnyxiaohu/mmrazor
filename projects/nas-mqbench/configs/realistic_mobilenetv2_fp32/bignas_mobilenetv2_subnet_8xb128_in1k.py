_base_ = './bignas_mobilenetv2_supernet_8xb128_in1k.py'
...
model = dict(
    ...
    fix_subnet='work_dirs/bignas_mobilenetv2_search_8xb128_in1k/default_fix_subnet.yaml',
    ...
    #     'work_dirs/bignas_mobilenetv2_search_8xb128_in1k/subnet_20230519_0915.pth',  # noqa: E501
    #     prefix='architecture.'))
