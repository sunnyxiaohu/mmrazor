...
from mmrazor.structures.quantization.backend_config.common_operator_config_utils import (
    _get_binary_op_configs, _get_conv_configs, _get_linear_configs, _get_share_qparams_op_configs)
...
def get_mutableopenvino_backend_config() -> BackendConfig:
    ...
    non_weighted_op_quint8_dtype_config = DTypeConfig(
        input_dtype=torch.quint8,
        output_dtype=torch.quint8,
    )
    ...
    conv_dtype_configs = [
        weighted_op_qint8_dtype_config, weighted_op_quint8_dtype_config
    ]
    ...
    share_qparams_op_dtype_configs = [
        non_weighted_op_qint8_dtype_config, non_weighted_op_quint8_dtype_config
    ]
    ...
    mutableopenvino_config = BackendConfig('mutableopenvino') \
...
def get_mutableopenvino_onlyweight_backend_config() -> BackendConfig:
    """Return the `BackendConfig` for the openvino backend.
    ...
    mutableopenvino_config = BackendConfig('mutableopenvino_onlyweight') \
        .set_backend_pattern_configs(_get_conv_configs(conv_dtype_configs)) \
        .set_backend_pattern_config(addmm_config) \
...
def get_mutableopenvino_onlyweight_backend_config_dict():
    """Return the `BackendConfig` for the openvino backend in dictionary
    form."""
    return get_mutableopenvino_onlyweight_backend_config().to_dict()


__all__ = [
    'get_mutableopenvino_backend_config',
    'get_mutableopenvino_backend_config_dict',
    'get_mutableopenvino_onlyweight_backend_config',
    'get_mutableopenvino_onlyweight_backend_config_dict',
]
