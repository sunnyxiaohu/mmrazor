_base_ = './cobits_openvinox_resnet18_supernet_8xb64_in1k.py'
...
global_qconfig = dict(
    ...
    w_qscheme=dict(qdtype='qint8', bit=8, is_symmetry=True, zero_point_trainable=True, is_symmetric_range=True),
