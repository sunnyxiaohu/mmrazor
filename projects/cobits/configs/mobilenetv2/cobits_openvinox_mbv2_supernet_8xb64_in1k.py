...
if is_finetune:
    ...
    work_dir = 'work_dirs/cobits_openvinox_mbv2_finetune_8xb64_in1k'
else:
    lr = 0.01
    weight_decay = 0.0001
    max_epochs = 5
...
global_qconfig = dict(
    ...
    w_qscheme=dict(qdtype='qint8', bit=4, is_symmetry=True, is_symmetric_range=False, extreme_estimator=1, param_share_mode=param_share_mode),
