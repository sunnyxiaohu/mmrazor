...
global_qconfig = dict(
    ...
    w_qscheme=dict(qdtype='qint8', bit=4, is_symmetry=False, is_symmetric_range=True, zero_point_trainable=True, extreme_estimator=1, param_share_mode=4),
    a_qscheme=dict(qdtype='quint8', bit=4, is_symmetry=False, zero_point_trainable=True, extreme_estimator=1, param_share_mode=4)
)
