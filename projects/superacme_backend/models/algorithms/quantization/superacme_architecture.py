...
from mmrazor.models.algorithms.base import BaseAlgorithm, BaseModel
...
class SuperAcmeArchitectureQuant(BaseAlgorithm):
    ...
    def __init__(self,
        ...
        self.dummy_input = torch.randn(self.input_shapes)
...
class SuperAcmeArchitectureQuantDDP(MMDistributedDataParallel):
    """DDPwapper for SuperAcmeArchitectureQuant.
    ...
    def sync_qparams(self, src_mode: str):
        """Same as in 'SuperAcmeArchitectureQuant'. Sync all quantize parameters in
