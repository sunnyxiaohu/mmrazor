_base_ = ['mmcls::mobilenet_v2/mobilenet-v2_8xb32_in1k.py', './mobilenetv2_supernet.py']

custom_imports = dict(
    imports =['projects.nasmq.models.architectures.backbones.searchable_mobilenet_v2'])
